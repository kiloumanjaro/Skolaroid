  ...
  return (
    <div ref={dropdownRef} className="relative w-full">
      <button
        ...
        className="flex w-full items-center gap-2 border border-[#1f1f1f] bg-white px-3 py-2 text-left shadow-none transition-colors hover:bg-[#f5f1e3]"
      >
        {selectedGroup ? (
          <>
      ...
      {isOpen && (
        <div className="absolute left-0 right-0 top-full z-30 mt-1 overflow-hidden border border-[#1f1f1f] bg-white shadow-none">
